...
SOURCE_TO_TEST_MAP = {
    ...
    "services/chat_stream_service.py": "tests/unit/test_chat_stream_service.py",
    ...
    "core/auth.py": "tests/unit/test_auth.py",
    "core/schemas.py": "tests/contracts/test_schemas.py",
