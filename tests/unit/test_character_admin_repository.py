"""character_admin_memory + character_admin_story repository 单元测试。"""
...
class TestAdminListMemories:
    def test_returns_rows(self):
        from repositories.character_admin_memory_repository import admin_list_memories
        rows = [
...
class TestAdminCreateMemory:
    def test_returns_new_id(self):
        from repositories.character_admin_memory_repository import admin_create_memory
...
class TestAdminGetMemory:
    def test_found(self):
        from repositories.character_admin_memory_repository import admin_get_memory
...
class TestAdminDeleteMemory:
    def test_executes_delete(self):
        from repositories.character_admin_memory_repository import admin_delete_memory
        conn = FakeSequenceConn([None])
...
class TestAdminListMemoryCategories:
    def test_returns_rows(self):
        from repositories.character_admin_memory_repository import admin_list_memory_categories
...
class TestAdminCreateMemoryCategory:
    def test_returns_new_id(self):
        from repositories.character_admin_memory_repository import admin_create_memory_category
...
class TestAdminCountMemoriesInCategory:
    def test_returns_count(self):
        from repositories.character_admin_memory_repository import admin_count_memories_in_category
...
class TestAdminGetMemoryCategoryForImpact:
    def test_returns_category(self):
        from repositories.character_admin_memory_repository import admin_get_memory_category_for_impact
...
class TestAdminListMemoriesInCategory:
    def test_returns_memories(self):
        from repositories.character_admin_memory_repository import admin_list_memories_in_category
...
class TestAdminListGreetings:
    def test_returns_rows(self):
        from repositories.character_admin_story_repository import admin_list_greetings
...
class TestAdminCreateGreeting:
    def test_returns_new_id(self):
        from repositories.character_admin_story_repository import admin_create_greeting
...
class TestAdminGetGreeting:
    def test_found(self):
        from repositories.character_admin_story_repository import admin_get_greeting
        conn = FakeSequenceConn([FakeRow({"id": 1})])
...
class TestAdminListStorylines:
    def test_returns_rows(self):
        from repositories.character_admin_story_repository import admin_list_storylines
...
class TestAdminClearDefaultStoryline:
    def test_clears_all(self):
        from repositories.character_admin_story_repository import admin_clear_default_storyline
        conn = FakeSequenceConn([None])
...
class TestAdminCreateStoryline:
    def test_returns_new_id(self):
        from repositories.character_admin_story_repository import admin_create_storyline
...
class TestAdminGetStoryline:
    def test_found(self):
        from repositories.character_admin_story_repository import admin_get_storyline
...
class TestAdminDetachStorylineRefs:
    def test_executes_three_updates(self):
        from repositories.character_admin_story_repository import admin_detach_storyline_refs
...
class TestAdminGetStorylineForImpact:
    def test_returns_storyline(self):
        from repositories.character_admin_story_repository import admin_get_storyline_for_impact
...
class TestAdminListGreetingsForStoryline:
    def test_returns_greetings(self):
        from repositories.character_admin_story_repository import admin_list_greetings_for_storyline
...
class TestAdminListPostRules:
    def test_returns_rows(self):
        from repositories.character_admin_story_repository import admin_list_post_rules
...
class TestAdminCreatePostRule:
    def test_returns_new_id(self):
        from repositories.character_admin_story_repository import admin_create_post_rule
...
class TestAdminGetPostRule:
    def test_found(self):
        from repositories.character_admin_story_repository import admin_get_post_rule
        conn = FakeSequenceConn([FakeRow({"id": 1})])
...
class TestAdminListStoryEvents:
    def test_returns_rows(self):
        from repositories.character_admin_story_repository import admin_list_story_events
...
class TestAdminCreateStoryEvent:
    def test_returns_new_id(self):
        from repositories.character_admin_story_repository import admin_create_story_event
...
class TestAdminGetStoryEvent:
    def test_found(self):
        from repositories.character_admin_story_repository import admin_get_story_event
        conn = FakeSequenceConn([FakeRow({"id": 1})])
...
class TestAdminDeleteStoryEvent:
    def test_executes_delete(self):
        from repositories.character_admin_story_repository import admin_delete_story_event
        conn = FakeSequenceConn([None])
