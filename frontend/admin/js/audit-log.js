...
async function loadAuditLogs() {
  ...
  try {
    ...
    const actionTag = {
      ...
      create_memory: ['create', '创建记忆'],
      update_memory: ['edit', '更新记忆'],
      delete_memory: ['delete', '删除记忆'],
      create_memory_category: ['create', '创建记忆分类'],
      update_memory_category: ['edit', '更新记忆分类'],
      delete_memory_category: ['delete', '删除记忆分类'],
      create_greeting: ['create', '创建开场白'],
      update_greeting: ['edit', '更新开场白'],
      delete_greeting: ['delete', '删除开场白'],
      create_storyline: ['create', '创建剧情线'],
      update_storyline: ['edit', '更新剧情线'],
      delete_storyline: ['delete', '删除剧情线'],
      create_post_rule: ['create', '创建后置规则'],
      update_post_rule: ['edit', '更新后置规则'],
      delete_post_rule: ['delete', '删除后置规则'],
      create_story_event: ['create', '创建剧情事件'],
      update_story_event: ['edit', '更新剧情事件'],
      delete_story_event: ['delete', '删除剧情事件'],
    };
